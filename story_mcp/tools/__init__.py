...
- version_tools: Git-based version control (get_version_history, checkout_version, compare_versions)
...
- get_version_history: Retrieve Git commit history
- checkout_version: Restore document to specific commit
- compare_versions: Generate diff between commits
"""
...
# MCP 2025-06-18 outputSchema support (loaded on demand)
try:
    from .schemas import get_all_tool_schemas, get_tool_schema, list_tools_by_category, TOOL_SCHEMAS

    __all__.extend(["get_all_tool_schemas", "get_tool_schema", "list_tools_by_category", "TOOL_SCHEMAS"])
except ImportError:
    # Schemas module not available
    pass

...
from ..helpers import _get_chapter_embeddings_path, _get_chapter_path, _get_embeddings_path
from ..logger_config import ErrorCategory, log_structured_error
from ..models import ChapterEmbeddingManifest, EmbeddingCacheEntry
...
class EmbeddingCache:
    ...
    def get_chapter_embeddings(self, document_name: str, chapter_name: str) -> Dict[int, np.ndarray]:
        ...
        try:
            ...
            log_structured_error(
                category=ErrorCategory.WARNING,
                message=f"Failed to get chapter embeddings",
                exception=e,
    ...
    def store_chapter_embeddings(self, document_name: str, chapter_name: str, 
        ...
        try:
            ...
            log_structured_error(
                ...
                message=f"Failed to store chapter embeddings",
                exception=e,
                context={"document_name": document_name, "chapter_name": chapter_name},
    ...
    def _is_cache_valid(self, document_name: str, chapter_name: str) -> bool:
        ...
        try:
            ...
            log_structured_error(
                category=ErrorCategory.WARNING,
                message=f"Failed to check cache validity",
                exception=e,
                context={"document_name": document_name, "chapter_name": chapter_name},
    ...
    def invalidate_chapter_cache(self, document_name: str, chapter_name: str):
        ...
        try:
            ...
            log_structured_error(
                category=ErrorCategory.WARNING,
                message=f"Failed to invalidate chapter cache",
                exception=e,
                context={"document_name": document_name, "chapter_name": chapter_name},
    ...
    def invalidate_document_cache(self, document_name: str):
        ...
        try:
            ...
            log_structured_error(
                category=ErrorCategory.WARNING,
                message=f"Failed to invalidate document cache",
                exception=e,

...
class BatchOperation(BaseModel):
    ...
    depends_on: Optional[List[str]] = Field(default=None, description="List of operation IDs this depends on")
...
class BatchApplyResult(BaseModel):
    ...
    operation_results: List[OperationResult] = Field(default_factory=list, description="Individual operation results")
    summary: str = Field(default="", description="Human-readable execution summary")
    error_summary: Optional[str] = Field(default=None, description="Error summary if batch failed")

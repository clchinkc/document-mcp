...
class ErrorClassifier:
    ...
    def classify(self, error: Exception) -> ErrorInfo:
        ...
        if any(keyword in error_str for keyword in ["connection", "timeout", "network", "unreachable", "502", "503", "504"]):
            return ErrorInfo(
...
def create_error_response(summary: str, error_type: str, details: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    """

...
class TestScopeBasedToolsBatchIntegration:
    ...
    @pytest.mark.asyncio
    async def test_batch_operations_with_scope_based_tools_dependencies(self, temp_docs_root, document_factory):
        ...
        response = batch_apply_operations(
            operations=dependent_operations,
            atomic=True,
            validate_only=False
        )

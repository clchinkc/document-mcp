...
from document_mcp.doc_tool_server import (
    ...
    create_chapter,
    delete_document,
    # Functions with safety decorators
...
class TestSafetyDecoratorCoverage:
    ...
    def test_write_chapter_content_safety_protection(self, temp_docs_root):
        ...
        try:
            ...
            assert "modified externally" in result.message.lower() or "force_write" in result.message.lower()
    ...
    def test_safety_decorator_coverage_completeness(self):
        ...
        for func in functions_with_safety:
            ...
            assert hasattr(func, '__wrapped__') or hasattr(func, '__name__'), f"Function {func.__name__} should be wrapped by safety decorator"

...
class PerformanceTracker:
    ...
    def record_tool_call(self, tool_name: str, execution_time: float, success: bool, 
                        error_message: Optional[str] = None, result_size: int = 0):
    ...
    def set_token_usage(self, prompt_tokens: int, completion_tokens: int, total_tokens: Optional[int] = None):
    ...
    def create_performance_test_scenarios() -> List[Dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                'expected_operations': ['create_document', 'create_chapter', 'create_chapter', 'create_chapter'],
                'max_tokens': {'simple': 800, 'react': 1500},
                'max_time': 15.0,
                'expected_files': ['ai_book/', 'ai_book/01-introduction.md', 'ai_book/02-methods.md', 'ai_book/03-conclusion.md']
            },
            {
...
def compare_agent_performance(metrics_simple: 'AgentPerformanceMetrics', 
                             metrics_react: 'AgentPerformanceMetrics') -> Dict[str, Any]:
...
def generate_performance_summary(metrics_list: List['AgentPerformanceMetrics']) -> Dict[str, Any]:
    ...
    summary = {
        ...
        'average_token_usage': sum(m.token_usage or 0 for m in metrics_list) / len(metrics_list) if metrics_list else 0,

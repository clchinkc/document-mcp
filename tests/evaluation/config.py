...
DEFAULT_TEST_SCENARIOS = [
    ...
    },
    {
        ...
        'expected_files': ['tutorial/', 'tutorial/basics.md', 'tutorial/advanced.md', 'tutorial/conclusion.md'],
    ...
    },
    {
        ...
        'expected_operations': ['create_document', 'create_chapter', 'create_chapter', 'create_chapter', 'get_document_statistics'],
        'expected_files': ['user_guide/', 'user_guide/installation.md', 'user_guide/configuration.md', 'user_guide/troubleshooting.md'],
        'category': 'complex'
    }
]
...
def get_operation_threshold(agent_type: str, operation: str, metric_type: str) -> Optional[float]:
